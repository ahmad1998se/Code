    ...
    class shape
    {
        ...
        public void DRAW(Graphics G, Pen P)
        {
            Point[] POLYGON = new Point[]
         {
            ...
            new Point(topleft.X+(width/3),topleft.Y),
            new Point(topleft.X+(width/3),topleft.Y+(height/3) ),
            new Point(topleft.X+(width*2/3) ,topleft.Y+(height/3) ),
            new Point(topleft.X+(width*2/3),topleft.Y+(height*2/3) ),
            new Point(topleft.X+width,topleft.Y+(height*2/3) ),
