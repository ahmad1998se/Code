...
public class player1 {
 ...
 if ((game[0][0]=='O'&&game[0][1]==game[0][0]&&game[0][1]==game[0][2]) || (game[1][0]=='O'&&game[1][0]==game[1][1]&&game[1][0]==game[1][2])||
            (game[2][0]=='O'&&game[2][0]==game[2][1]&&game[2][1]==game[2][2])||(game[0][0]=='O'&&game[0][0]==game[1][0]&&game[1][0]==game[2][0])||
            (game[0][1]=='O'&&game[0][1]==game[1][1]&&game[1][1]==game[2][1])||
           (game[0][2]=='O'&&game[0][2]==game[1][2]&&game[1][2]==game[2][2])||
          (game[0][0]=='O'&&game[0][0]==game[1][1]&&game[1][1]==game[2][2])||
          (game[0][2]=='O'&&game[0][2]==game[1][1]&&game[1][1]==game[2][0]))
         {
             other=true;
         return true;
         }
    ...
    public static void main(String[] args) {
        try {
           ...
           System.out.println("im Player 1 (X Player)");
           while(true){
         ...
         if ((choices.contains(1)&&choices.contains(2)&&choices.contains(3))||(choices.contains(4)&&choices.contains(5)&&choices.contains(6))||(choices.contains(7)&&choices.contains(8)&&choices.contains(9))||(choices.contains(1)&&choices.contains(4)&&choices.contains(7))||(choices.contains(2)&&choices.contains(5)&&choices.contains(8))||(choices.contains(3)&&choices.contains(6)&&choices.contains(9))||(choices.contains(1)&&choices.contains(5)&&choices.contains(9))||(choices.contains(3)&&choices.contains(5)&&choices.contains(7)))
         {
            ...
            break;
                ...
                if (GameEnded(game)){
                      if (other)System.out.print("player 2 wins");
